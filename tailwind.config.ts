  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        'primitives-colors-light-main-gray-0-white': 'var(--primitives-colors-light-main-gray-0-white)',
        'primitives-colors-light-main-gray-100': 'var(--primitives-colors-light-main-gray-100)',
        'primitives-colors-light-main-gray-500': 'var(--primitives-colors-light-main-gray-500)',
        'primitives-colors-light-main-gray-600': 'var(--primitives-colors-light-main-gray-600)',
        'primitives-colors-light-main-gray-700': 'var(--primitives-colors-light-main-gray-700)',
        'semantic-colors-colors-main-0-goten': 'var(--semantic-colors-colors-main-0-goten)',
        'semantic-colors-colors-main-500-zeno': 'var(--semantic-colors-colors-main-500-zeno)',
        'semantic-colors-persian-ui-do-not-matter-main': 'var(--semantic-colors-persian-ui-do-not-matter-main)',

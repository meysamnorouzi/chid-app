        ...
        <div className="flex-1 min-h-0 flex flex-col w-full items-center justify-start pt-4 pb-4 px-4 overflow-y-auto md:justify-center md:pt-0 md:p-8 md:overflow-visible">
          <div className="w-full mb-4 md:mb-0">
            ...
            <button
              type="submit"
              disabled={isLoading}
              className="w-full bg-[#7e4bd0] hover:bg-gray-800 disabled:bg-gray-400 disabled:cursor-not-allowed text-white font-semibold py-3 rounded-xl shadow-gray-300 transition-all active:scale-[0.98] md:py-3.5"
            >

...
type TabType = "all" | "gifts" | "wallet" | "shop";
    ...
    switch (activeTab) {
      case "gifts":
        filtered = filtered.filter(
          (activity) => activity.type === "thanks" || activity.type === "task"
        );
        break;
      case "wallet":
        filtered = filtered.filter(
        ...
        break;
      case "shop":
        filtered = filtered.filter((activity) => activity.type === "request");
        break;
      default:
        // "all" - no filter
        break;
        ...
        <div className="bg-white min-h-screen px-4 py-6 max-w-4xl mx-auto">
          ...
          >
            ...
            <p className="text-gray-600 text-sm mb-3">
              پیام ها و فعالیت‌های شما در این قسمت نمایش داده میشه
            </p>
            {/* Search Bar */}
            <div className="relative">
              ...
              <input
                ...
                placeholder="جستجو در پیام‌ها و فعالیت‌ها..."
                className="w-full pr-10 pl-4 py-3 bg-gray-100 rounded-xl border-0 focus:ring-2 focus:ring-indigo-500 focus:bg-white transition-all outline-none"
              />
            </div>
          </motion.div>
          ...
          <div className="grid grid-cols-4 gap-3 mb-4">
            <motion.button
              ...
              className={`h-20 border mb-3 flex items-center justify-center flex-col rounded-lg transition-all ${
                activeTab === "all"
            ...
            >
              <HeartIcon
                className={`w-6 h-6 ${
                  activeTab === "all" ? "text-[#7e4bd0]" : "text-gray-700"
                }`}
              />
              <p
                className={`text-xs font-semibold mt-1 ${
                  activeTab === "all" ? "text-[#7e4bd0]" : "text-gray-900"
                }`}
              >
                همه
              </p>
            ...
            >
              <GiftIcon
                className={`w-6 h-6 ${
                  activeTab === "gifts" ? "text-[#7e4bd0]" : "text-gray-700"
                }`}
              />
              <p
                className={`text-xs font-semibold mt-1 ${
                  activeTab === "gifts" ? "text-[#7e4bd0]" : "text-gray-900"
                }`}
              >
                هدیه ها
              </p>
            ...
            >
              <WalletIcon
                className={`w-6 h-6 ${
                  activeTab === "wallet" ? "text-[#7e4bd0]" : "text-gray-700"
                }`}
              />
              <p
                className={`text-xs font-semibold mt-1 ${
                  activeTab === "wallet" ? "text-[#7e4bd0]" : "text-gray-900"
                }`}
              >
                کیف پول
              </p>
            ...
            >
              <ShoppingBagIcon
                className={`w-6 h-6 ${
                  activeTab === "shop" ? "text-[#7e4bd0]" : "text-gray-700"
                }`}
              />
              <p
                className={`text-xs font-semibold mt-1 ${
                  activeTab === "shop" ? "text-[#7e4bd0]" : "text-gray-900"
                }`}
              >
                فروشگاه
              </p>
                  ...
                  <div className="flex items-start gap-4">
                    ...
                    <div className="relative shrink-0">
                      <img
                        ...
                        className="w-12 h-12 rounded-full object-cover border-2 object-top border-gray-200"
                      />
                      <div

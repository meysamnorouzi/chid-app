/**
 * With Active Icons Page for BottomNavigation
 */

import { useState } from 'react';
import { BottomNavigation, CodeBlock } from '../../../components/shared';
import { useDocumentationTheme } from '../../../theme';
import { withActiveIconsCode } from './codeExamples/codeExamples';

const WithActiveIcons = () => {
  ...
  return (
    <div className="w-full mb-8">
      <header className="mb-8">
        ...
        >
          BottomNavigation with different icons for active and inactive states.
        </p>
      </header>
...
export default WithActiveIcons;
